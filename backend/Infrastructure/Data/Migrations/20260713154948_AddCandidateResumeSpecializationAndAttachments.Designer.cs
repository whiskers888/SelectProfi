...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260713154948_AddCandidateResumeSpecializationAndAttachments")]
    partial class AddCandidateResumeSpecializationAndAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.Candidate", b =>
                {
                    ...
                    b.Property<Guid?>("CreatedByExecutorId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.CandidateResume", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("PdfExportAllowed")
                    ...
                    b.HasIndex("CandidateId", "DeletedAtUtc");
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.CandidateResumeAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CandidateResumeAttachments");
                });

            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.VacancyCandidate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("AddedByExecutorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VacancyId", "Stage", "DeletedAtUtc");
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Vacancies.Vacancy", b =>
                {
                    ...
                    b.Property<DateTime?>("ShortlistSentToCustomerAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.CandidateResume", b =>
                {
                    b.HasOne("SelectProfi.backend.Domain.Candidates.Candidate", "Candidate")
                        .WithMany("Resumes")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SelectProfi.backend.Domain.Users.User", "OwnerUser")
                        .WithMany()
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SelectProfi.backend.Domain.Orders.OrderSpecialization", "Specialization")
                        .WithMany()
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.CandidateResumeAttachment", b =>
                {
                    b.HasOne("SelectProfi.backend.Domain.Candidates.CandidateResume", "CandidateResume")
                        .WithMany()
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Candidates.VacancyCandidate", b =>
                {
                    b.HasOne("SelectProfi.backend.Domain.Users.User", "AddedByExecutor")
                        .WithMany()
                        .HasForeignKey("AddedByExecutorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SelectProfi.backend.Domain.Candidates.Candidate", "Candidate")
                        .WithMany("VacancyLinks")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SelectProfi.backend.Domain.Vacancies.Vacancy", "Vacancy")
                        .WithMany("VacancyCandidates")
                        .HasForeignKey("VacancyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("AddedByExecutor");
            ...
            modelBuilder.Entity("SelectProfi.backend.Domain.Vacancies.Vacancy", b =>
                {
                    ...
                    b.HasOne("SelectProfi.backend.Domain.Candidates.Candidate", "SelectedCandidate")
                        .WithMany()

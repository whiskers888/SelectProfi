import { type WorkspaceMeeting, type WorkspaceTone } from '../model/data'
...
function groupedMeetings(meetings: WorkspaceMeeting[]): Array<{ date: string, meetings: WorkspaceMeeting[] }> {

...
export type WorkspaceView = 'dashboard' | 'orders' | 'candidates' | 'meetings' | 'chats' | 'analytics'
...
const customerData: WorkspaceDataset = {
...
const applicantData: WorkspaceDataset = {
...
export const workspaceDataByRole: Record<WorkspaceRole, WorkspaceDataset> = {
  Customer: customerData,
  Executor: executorData,
  Applicant: applicantData,
}

export const defaultWorkspaceRole: WorkspaceRole = 'Customer'

export const defaultWorkspaceView: WorkspaceView = 'dashboard'
